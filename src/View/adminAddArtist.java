 ...
 * @author ciara
 */
public class adminAddArtist extends javax.swing.JFrame {
private static adminAddArtist obj=null;
    
    public adminAddArtist() {
        initComponents();
    }

    public static adminAddArtist getObj(){
        if(obj==null){
           obj= new adminAddArtist();
        }return obj;
    }
    /**
    ...
    public String getaddIDA() {
        return addIDA.getText();
    }

    public String getaddNameA() {
        return addNameA.getText();
    }

    public String getaddaboutA() {
        return addAboutA.getText();
    }
